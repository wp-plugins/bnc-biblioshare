...
<td><textarea cols="80" rows="8" name="<?php echo BN_OPTION_TEMPLATE1_NAME ?>" ><?php echo $template1; ?></textarea></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTION_TEMPLATE2_LANG ?></td>
<td><textarea cols="80" rows="8" name="<?php echo BN_OPTION_TEMPLATE2_NAME ?>" ><?php echo $template2; ?></textarea></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTION_TEMPLATE3_LANG ?></td>
<td><textarea cols="80" rows="8" name="<?php echo BN_OPTION_TEMPLATE3_NAME ?>" ><?php echo $template3; ?></textarea></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTION_TEMPLATE4_LANG ?></td>
<td><textarea cols="80" rows="8" name="<?php echo BN_OPTION_TEMPLATE4_NAME ?>" ><?php echo $template4; ?></textarea></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTION_TEMPLATE5_LANG ?></td>
<td><textarea cols="80" rows="8" name="<?php echo BN_OPTION_TEMPLATE5_NAME ?>" ><?php echo $template5; ?></textarea></td>
</tr>
...
<td width="28%"><input type="text" name="<?php echo BN_OPTION_FINDINLIBRARY_OPENURLRESOLVER_NAME ?>" value="<?php echo $openurlresolver; ?>" size="50" /></td>
...
<td><input type="text" name="<?php echo BN_OPTION_FINDINLIBRARY_PHRASE_NAME; ?>" value="<?php echo $findinlibraryphrase; ?>" size="50" /></td>
<td><?php echo BN_OPTIONS_FINDINLIBRARY_PHRASE_DETAIL_LANG; ?></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTIONS_FINDINLIBRARY_IMAGESRC_LANG; ?></td>
<td><input type="text" name="<?php echo BN_OPTION_FINDINLIBRARY_IMAGESRC_NAME; ?>" value="<?php echo $findinlibraryimagesrc; ?>" size="50" /></td>
...
<td><input type=text name="<?php echo BN_OPTION_PROXY_NAME ?>" value="<?php echo $proxy; ?>" size="50" /></td>
<td><?php echo BN_OPTION_SYSTEM_PROXY_DETAIL_LANG; ?></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTION_SYSTEM_PROXYPORT_LANG; ?></td>
<td><input type=text name="<?php echo BN_OPTION_PROXYPORT_NAME ?>" value="<?php echo $proxyport; ?>" size="5" /></td>
<td><?php echo BN_OPTION_SYSTEM_PROXYPORT_DETAIL_LANG; ?></td>
</tr>

<tr valign="top">
<td><?php echo BN_OPTION_SYSTEM_TIMEOUT_LANG; ?></td>
<td><input type=text name="<?php echo BN_OPTION_TIMEOUT_NAME ?>" value="<?php echo $timeout; ?>" size="5" /></td>
